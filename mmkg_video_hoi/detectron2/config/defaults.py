...
# Size of VidOR. Options: ("large", "small", "small-10imgs")
# _C.DATASETS.VIDOR.SIZE = "small"
...
# Options are: "cross_entropy_loss", "focal_loss"
_C.MODEL.ROI_BOX_HEAD.BBOX_CLS_LOSS_TYPE = "cross_entropy_loss"
...
# and access it with:
#
# from mmkg_video_hoi.detectron2.config import global_cfg
