...
from mmkg_video_hoi.detectron2.layers import ShapeSpec, batched_nms_rotated
from mmkg_video_hoi.detectron2.structures import Instances, RotatedBoxes, pairwise_iou_rotated
